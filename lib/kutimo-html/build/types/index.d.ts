export declare type KutimoFunctionName = string;
/**
 ...
 */
export declare type KutimoHTMLCompileResult = {
    authorToken: string;
    validation: boolean;
    sanitized: boolean;
 ...
 */
export declare const html: (strings: TemplateStringsArray, ...values: unknown[]) => KutimoHTMLCompileResult;
/**
