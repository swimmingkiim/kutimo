 ...
 */
export class PageElement extends KutimoBaseElement {
}
...
/**
 * getDependencies returns unique Kutimo element classes array which appeared on your RouteMap.
...
export default class RouterElement extends KutimoBaseElement {
    ...
    onStart(): void {
        console.log("router event handler initialized")
